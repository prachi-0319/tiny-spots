...
const Map: React.FC<MapProps> = ({ vendors, onSelectVendor }) => {
  return (
    <div className="w-full h-full min-h-[500px] bg-[#E5E0D8] relative overflow-hidden cursor-move touch-none">
      ...
      {/* Decorative Map Elements (Mock Roads/Parks) */}
      ...
      <div className="absolute bottom-4 right-4 bg-white p-2 border-2 border-neo-black shadow-hard rounded-lg text-xs font-bold pointer-events-none opacity-80">
        Stylized Map View
      </div>
    </div>
  );
